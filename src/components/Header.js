  ...
  return (
    <div className="flex justify-between mx-2 max-w-6xl sm:mx-auto items-right py-6">
      ...
      <div className="flex items-center space-x-5">
        ...
        <Button
          text="Login"
          styleName="font-inter text-amber-500  border-2 border-amber-500 py-2 px-6 rounded-lg mr-1"
        ></Button>
        <Button
          text="Register"
          styleName="font-inter text-white bg-amber-500 py-2 px-6 rounded-lg mr-1"
        ></Button>
      </div>
    </div>
  );
